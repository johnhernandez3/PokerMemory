...
public class Card extends JLabel implements MouseListener
{
	...
	/*
	 * @return it returns the integer value of the Rank.
	 * */
	public int getRankInt(){ // Converts the rank of a target Card into an Integer
		if (getRank().equals("t")){
			return 10;
		}
		else if (getRank().equals("j")){
			return 11;
		}
		else if (getRank().equals("q")){
			return 12;
		}
	...
	public void showLastCard(){ //It's used to display the last card picked by the user. Avoids the delay.
