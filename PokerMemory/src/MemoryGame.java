...
public class MemoryGame implements ActionListener {
	...
	public MemoryGame() throws IOException {
		...
		this.mainFrame = new JFrame("Trump's Memory Challenge");
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			if (e.getActionCommand().equals("Easy Level"))
				newGame("easy");
			else if (e.getActionCommand().equals("Equal Pair Level"))
				newGame("medium");
			else if (e.getActionCommand().equals("Same Rank Trio Level"))
				newGame("trio");
			else if (e.getActionCommand().equals("Flush Level"))
				newGame("flush");
			else if (e.getActionCommand().equals("Straight Level"))
				newGame("straight");
			else if (e.getActionCommand().equals("Combo Level"))
				newGame("combo");
	...
	public void newGame(String difficultyMode) throws IOException {
		...
		if (difficultyMode.equalsIgnoreCase("easy")) {
			this.difficulty = new EasyLevel(this.turnCounterLabel,
					this.mainFrame);
		...
		this.mainContentPane.setBackground(Color.PINK);

		// add the turn counter label back in again
		this.mainContentPane.add(this.turnCounterLabel);

		// add the score label
		this.mainContentPane.add(this.score);
		
		// show the window (in case this is the first game)
		this.mainFrame.setVisible(true);
	}

	public boolean gameOver() throws FileNotFoundException,
